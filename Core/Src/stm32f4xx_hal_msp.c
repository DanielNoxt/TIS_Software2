...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PB1     ------> ADC1_IN9
    */
    GPIO_InitStruct.Pin = Elec3_Pin|Elec2_Pin|Elec1_Pin|MicroElec_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = MeasSin_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(MeasSin_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = Eref_Pin|V_batt_FB_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC1_IN9
    */
    HAL_GPIO_DeInit(GPIOA, Elec3_Pin|Elec2_Pin|Elec1_Pin|MicroElec_Pin);

    HAL_GPIO_DeInit(MeasSin_GPIO_Port, MeasSin_Pin);

    HAL_GPIO_DeInit(GPIOB, Eref_Pin|V_batt_FB_Pin);
